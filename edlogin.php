...
$session = $_SESSION['eusername'];

$query= "select * from eduloan where eusername='".$session."'";
...
<!-- Header -->
<header >
  <br><h1 class="w3-margin w3-center w3-text-blue w3-jumbo ">ABC Bank</h1>
  <p class="w3-xlarge w3-center w3-text-blue">Status Page.</p>
  </header>
...
<td style="text-align:right;"><input type="text" name="eusername" value="<?php echo $value['eusername']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Email-ID</label></th>
<td style="text-align:right;"><input type="text" name="eemail" value="<?php echo $value['eemail']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Mobile No</label></th>
<td style="text-align:right;"><input type ="text" name="emobile" value="<?php echo $value['emobile']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Expected Loan Amount</label></th>
<td style="text-align:right;"><input type="text" name="eamount" value="<?php echo $value['eamount']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Annual Income</label></th>
<td style="text-align:right;"><input type="text" name="eincome" value="<?php echo $value['eincome']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Aadhar No</label></th>
<td style="text-align:right;"><input type="text" name="eadhaar" value="<?php echo $value['eadhaar']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Acc.no</label></th>
<td style="text-align:right;"><input type="text" name="eaccno" value="<?php echo $value['eaccno']; ?>"></td>
</tr>
<tr>
<th style="text-align:left" ><label>Address</label></th>
<td style="text-align:right;" ><input type="text" name="eaddress" value="<?php echo $value['eaddress']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Status </label></th>
<td style="text-align:right;"><input type="text" name="estatus" value="<?php echo $value['admin']; ?>"></td>
</tr>
</table><br>
  </center>
