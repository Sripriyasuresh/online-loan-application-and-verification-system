...
$session = $_SESSION['husername'];

$query= "select * from homeloan where husername='".$session."'";
...
<header>
  ...
  <p class="w3-xlarge w3-center w3-text-white">Status Page.</p>
  </header>
...
<td style="text-align:right;"><input type="text" name="husername" value="<?php echo $value['husername']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Email-ID</label></th>
<td style="text-align:right;"><input type="text" name="hemail" value="<?php echo $value['hemail']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Mobile No</label></th>
<td style="text-align:right;"><input type ="text" name="hmobile" value="<?php echo $value['hmobile']; ?>"></td>
</tr>
<tr>
<th style="text-align:left" ><label>Address</label></th>
<td style="text-align:right;" ><input type="text" name="haddress" value="<?php echo $value['haddress']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Aadhar No</label></th>
<td style="text-align:right;"><input type="text" name="hadhaar" value="<?php echo $value['hadhaar']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Acc.no</label></th>
<td style="text-align:right;"><input type="text" name="haccno" value="<?php echo $value['haccno']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Annual Income</label></th>
<td style="text-align:right;"><input type="text" name="hincome" value="<?php echo $value['hincome']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Expected Loan Amount</label></th>
<td style="text-align:right;"><input type="text" name="hamount" value="<?php echo $value['hamount']; ?>"></td>
</tr>
<tr>
<th style="text-align:left"><label>Status </label></th>
<td style="text-align:right;"><input type="text" name="admin" value="<?php echo $value['admin']; ?>"></td>
</tr>
