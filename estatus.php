...
$session = $_SESSION['eemail'];

$query= "select * from eduloan where eemail='".$session."'";
...
<tr>
<th style="text-align:left"><label>Status of Student</label></th>
<td style="text-align:right;"><?php echo $value['sstatus']; ?></td>
</tr>
<tr>
<th style="text-align:left"><label>College Name</label></th>
<td style="text-align:right;"><?php echo $value['ecollege']; ?></td>
</tr>
<tr>
<th style="text-align:left"><label>Email-ID</label></th>
<td style="text-align:right;"><?php echo $value['eemail']; ?></td>
</tr>
<tr>
<th style="text-align:left"><label>Expected Loan Amount</label></th>
<td style="text-align:right;"><?php echo $value['eamount']; ?></td>
</tr>
<tr>
<th style="text-align:left"><label>Parent's Salary</label></th>
<td style="text-align:right;"><?php echo $value['eincome']; ?></td>
</tr>
<tr>
<th style="text-align:left"><label>Acc.no</label></th>
<td style="text-align:right;"><?php echo $value['eaccno']; ?></td>
</tr>
<tr>
<th style="text-align:left"><label>Aadhar No</label></th>
<td style="text-align:right;"><?php echo $value['eadhaar']; ?></td>
</tr>
<tr>
<th style="text-align:left" ><label>Address</label></th>
<td style="text-align:right;" ><?php echo $value['eaddress']; ?></td>
</tr>
<tr>
<th style="text-align:left"><label>Mob.no</label></th>
<td style="text-align:right;"><?php echo $value['emobile']; ?></td>
</tr>
</table><br>
