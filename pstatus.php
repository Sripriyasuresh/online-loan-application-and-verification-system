...
$session = $_SESSION['pemail'];

$query= "select * from persloan where pemail='".$session."'";
...
<td style="text-align:right;"> <?php echo $value['pemail']; ?></td>
</tr>
<tr>
<th style="text-align:left"><label>Expected Loan Amount</label></th>
<td style="text-align:right;"><?php echo $value['pamount']; ?></td>
</tr>
<tr>
<th style="text-align:left"><label>Annual Income</label></th>
<td style="text-align:right;"><?php echo $value['pincome']; ?></td>
</tr>
<tr>
<th style="text-align:left"><label>Acc.no</label></th>
<td style="text-align:right;"><?php echo $value['paccno']; ?></td>
</tr>
<tr>
<th style="text-align:left"><label>Aadhar No</label></th>
<td style="text-align:right;"><?php echo $value['padhaar']; ?></td>
</tr>
<tr>
<th style="text-align:left" ><label>Address</label></th>
<td style="text-align:right;" ><?php echo $value['paddress']; ?></td>
</tr>
<tr>
<th style="text-align:left"><label>Mob.no</label></th>
<td style="text-align:right;"><?php echo $value['pmobile']; ?></td>
</tr>
